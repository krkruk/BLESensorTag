...
public class DBTableOpticalSensorParam implements DBTableParamInterface {

    public static final String TABLE_NAME = "OpticalSensorParam";
    ...
    public DBTableOpticalSensorParam() {
    }
