...
import pl.projektorion.krzysztof.blesensortag.adapters.DBSelectStethoscopeParamRootAdapter;
...
public class DBSelectStethoscopeParamRootFragment extends ListFragment {
    ...
    public static final String EXTRA_RECORD_DATA =
            "pl.projektorion.krzysztof.blesensortag.fragments.app.extra.RECORD_DATA";
    ...
    private DBSelectStethoscopeParamRoot stethoscopeParamRootQuery =
            new DBSelectStethoscopeParamRoot();
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        bundle.putParcelable(EXTRA_RECORD_DATA, record);
    ...
    private void init_db_cursor()
    {
        ...
        try {
            ...
            Log.i("QUERY", stethoscopeParamRootQuery.getQuery());
            cursor = db.rawQuery(stethoscopeParamRootQuery.getQuery(),
                    stethoscopeParamRootQuery.getQueryData());
        } catch (Exception e) {
            cursor = null;
    ...
    {
        cursorAdapter = new DBSelectStethoscopeParamRootAdapter(getActivity(),
