...
public class BLeServiceScannerAdapter extends BaseExpandableListAdapter {

    private List<BluetoothGattService> services;
    private Context context;
    private LayoutInflater inflater;

    public BLeServiceScannerAdapter(Context context, List<BluetoothGattService> services) {
        super();
